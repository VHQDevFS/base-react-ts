...
import type { NeverField, MaybeElementRenderProps, RequireField } from '@/types';
import type {
  ModalOverlayProps,
  ModalProps,
  UseDisclosureProps,
  ...
  return (
    <>
      ...
      <Modal
        ...
        onClose={onClose}
      >
        <ModalOverlay bg="rgba(0, 0, 0, 0.6)" {...overlayProps} />
        <ModalContent maxH={{ base: '70vh', md: '90vh' }} pb="24px" {...modalContentProps}>
          <ModalHeader
            fontWeight={500}
            fontSize="md"
            lineHeight="27px"
